...
new_script_process = {
    'env': {
        'JAVA_HOME': r'/opt/java'
        ,
        'JAVA_URL': r'http://download.oracle.com/otn-pub/java/jdk/7u75-b13/jdk-7u75-linux-x64.tar.gz'
    }
}
...
parsed_output = execute(ctx.download_resource('tomcat-war-types/scripts/java_install.sh'), new_script_process, operationOutputNames)
