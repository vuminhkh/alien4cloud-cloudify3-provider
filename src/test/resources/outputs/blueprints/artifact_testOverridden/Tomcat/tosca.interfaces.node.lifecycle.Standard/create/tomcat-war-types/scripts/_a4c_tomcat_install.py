...
new_script_process = {
    'env': {
        'TOMCAT_PORT': r'80'
        ,
        'TOMCAT_URL': r'http://apache.crihan.fr/dist/tomcat/tomcat-8/v8.0.24/bin/apache-tomcat-8.0.24.tar.gz'
        ,
...
parsed_output = execute(ctx.download_resource('tomcat-war-types/scripts/tomcat_install.sh'), new_script_process, operationOutputNames)
