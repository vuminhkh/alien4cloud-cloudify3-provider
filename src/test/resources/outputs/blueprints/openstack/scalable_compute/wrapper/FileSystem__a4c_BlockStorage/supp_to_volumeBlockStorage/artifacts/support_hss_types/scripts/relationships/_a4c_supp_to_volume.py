...
env_map['TARGET_BLOCKSTORAGE_DEVICE'] = get_nested_attribute(ctx.target, ['volumes', 'BlockStorage', 'device_name'])
...
parsed_output = execute(ctx.download_resource('artifacts/support_hss_types/scripts/relationships/supp_to_volume.sh'), new_script_process, operationOutputNames)
