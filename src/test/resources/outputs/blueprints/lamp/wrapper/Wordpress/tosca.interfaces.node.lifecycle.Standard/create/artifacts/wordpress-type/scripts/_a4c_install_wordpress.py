...
new_script_process = {
    'env': {
        'WEBFILE_URL': r'https://wordpress.org/latest.zip'
    }
}
...
parsed_output = execute(ctx.download_resource('artifacts/wordpress-type/scripts/install_wordpress.sh'), new_script_process, operationOutputNames)
...
ctx.instance.runtime_properties['wordpress_url'] = r'http://' + get_attribute(ctx, 'floating_ip_address') + r':' + r'80' + r'/'
ctx.instance.update()
