...
new_script_process = {
    'env': {
        ...
        'DB_NAME': r'wordpress'
        ,
        'DB_IP': get_attribute(ctx.target, 'ip')
        ,
        'DB_PASSWORD': r'pass'
    }
}
...
parsed_output = execute(ctx.download_resource('wordpress-type/scripts/config_wordpress_for_mysql.sh'), new_script_process, operationOutputNames)
