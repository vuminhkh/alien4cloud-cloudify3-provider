...
env_map['VOLUME_HOME'] = r'/var/mysql'
...
parsed_output = execute(ctx.download_resource('artifacts/mysql-type/scripts/start_mysql.sh'), new_script_process, operationOutputNames)
