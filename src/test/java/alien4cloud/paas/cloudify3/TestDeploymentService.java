...
public class TestDeploymentService extends AbstractDeploymentTest {
    ...
    private String getIpAddress(String deploymentId) {
        NodeInstance[] nodeInstances = nodeInstanceDAO.list(deploymentId);
        String ipServer = null;
        for (NodeInstance nodeInstance : nodeInstances) {
            if ("_a4c_floating_ip_Server_on_NetPub".equals(nodeInstance.getNodeId())) {
    ...
    public void testDeployLamp() throws Exception {
        ...
        HttpUtil.checkUrl("http://" + getIpAddress(deploymentId) + "/wp-admin/install.php", null, 120000L);
    }
